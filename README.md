...
There are also lookup tables for customer types, account types, account statuses, transaction types, and loan statuses.
...
Additional dimensions such as Date, Branch, Transaction Type, and Loan Status are used for analysis and reporting.
...
Deposit — 15,065 transactions — ₹37.65M
Transfer — 14,771 transactions — ₹37.18M
Withdrawal — 14,706 transactions — ₹36.74M
Payment — 4,958 transactions — ₹12.38M
...
Therefore, these accounts should be viewed as candidates for further investigation or monitoring rather than confirmed fraudulent accounts.
...
For example, an account with unusually high transaction activity and significant loan exposure may deserve more attention than an account that is unusual on only one measure.
...
Most transaction activity is concentrated between January 2020 and January 2024.
